...
public class Main {
     ...
     * размером 4х4.
     * При подаче массива другого размера необходимо выбросить исключение
     * MyArraySizeException.
     * 2.Далее метод должен пройтись по всем элементам массива, преобразовать в int
     * и просуммировать.
     * Если в какомто эл-те массива преобразование не удалось (например, в ячейке
     * лежит символ или текст
     * вместо числа), должно быть брошено исключение MyarrayDataExeption с
     * детализацией в какой именно
